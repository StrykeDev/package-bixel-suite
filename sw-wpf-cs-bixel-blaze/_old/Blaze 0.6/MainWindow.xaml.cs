...
namespace Blaze
{
    public partial class MainWindow : INotifyPropertyChanged
    {
        ...
        // Services flags
        public static bool _pauseCL = false;
        public static bool _pauseMD = false;


        // Threads
        public static Thread thHotkeys = new Thread(HotkeysService);
        public static Thread thActiveApp = new Thread(ActiveAppsService);
        ...
        private bool _startup = regKeyStartup.GetValue("Blaze") != null;
        public bool Startup
        {
            get { return _startup; }
            set
