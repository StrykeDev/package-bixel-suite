...
namespace Blaze
{
    public partial class MainWindow : INotifyPropertyChanged
    {
        ...
        public MainWindow()
        {
            ...
            System.Collections.Specialized.StringCollection blacklistedApps = new System.Collections.Specialized.StringCollection();
                ...
                if (fullscreenApp)
                {
                    ...
                    if (fullscreenApp)
                    {
                        ...
                        if (!dimFlag)
                        {
                            ...
                            // Check if the active app in the list
                            if (blacklist.Contains(pName.ToLower()))
                            {
                                // If whitelisted
                                if (!Properties.Settings.Default.BlacklistMode)
                                {
